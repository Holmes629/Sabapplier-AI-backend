...
DEFAULT_FILE_STORAGE = 'googledrive_storage.GoogleDriveStorage'
GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE = BASE_DIR / "credential.json"
# GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE = os.path.join(BASE_DIR, 'credentials.json')
GOOGLE_DRIVE_STORAGE_MEDIA_ROOT = 'SabApplier-AI-file-storage_1' # OPTIONAL
