...
def get_autofill_data(raw_html, user_data):
    ...
    instructions = (
        ...
        "2. Match it with the appropriate value that can be filled at that form field.\n"
        "3. Add 'type': 'input', 'textarea', 'checkbox', 'label', or 'file'.\n"
        "4. If no value matches, fill value that feels appropriate.\n"
        "5. Keep order from top to bottom of HTML.\n"
        "6. Only return a list of JSONs like this:\n"
    ...
    raw_autofill = response_stage_1.text.strip()

    print("🔹 Stage 1 autofill data (raw):")
    ...
    print("✅ Stage 2 improved autofill data:")
    print(improved_autofill)
