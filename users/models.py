...
class user(models.Model):     
    ...
    profile_photo=models.FileField(upload_to=profile_photo_upload_path, storage=dropbox_storage, null=True)
    aadhaar_card=models.FileField(upload_to=aadhaar_card_upload_path, storage=dropbox_storage, null=True)
    pan_card=models.FileField(upload_to=pan_card_upload_path, storage=dropbox_storage, null=True)
